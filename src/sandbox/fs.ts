import { Volume as _Volume } from 'memfs';

export type FS = InstanceType<typeof _Volume>;
...
export class FileSystemApi {
  ...
  > {
    return this.fs.promises.readdir(path, options);
  }
  ...
  public async writeFile(
    ...
    await this.fs.promises.writeFile(path, data, options);
  }
  ...
  public watch(
    ...
    return this.fs.watch(path, options, listener);
  }
}
