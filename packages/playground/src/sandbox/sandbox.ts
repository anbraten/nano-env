...
import { SandboxProcess, SpawnOptions } from './types';
import { JSH } from './jsh';
...
export class Sandbox {
  ...
  private async createFileTree(root: string, node: FileSystemTree) {
  ...
  public on(event: string, listener: (code: number) => void) {
